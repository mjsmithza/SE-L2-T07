...
class Project {
	...
	private static ProjectForm getProjectForm(){
		...
		double totalFeeCharge = getDoubleData("Please enter the total fee being charged for the project.");
		double totalAmountPaid =getDoubleData("Please enter the total amount paid to date of the project.");
